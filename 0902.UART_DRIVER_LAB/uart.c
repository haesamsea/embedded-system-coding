...
//딴 일 가능
//메인 루프가 여러 가지 일을 동시에 처리해야 하는 경우
char Uart1_Get_Pressed(void)
{
	unsigned int flag;

	
	flag = Macro_Check_Bit_Set(USART1->SR, 5);
	// 글자가 입력이 되었으면 입력된 글자를 리턴 (sr5)
	if (flag == 1) return USART1->DR;
	// 글자 입력이 없으면 0 리턴
...
//입력받을때까지 아무것도 안함
//프로그램 흐름상 다음 동작을 하려면 반드시 입력이 있어야 하는 경우
